    ...
    <section id="culture" className="py-24 bg-black text-white relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col mb-16">
          <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-white/30 mb-4">
            Culture & Editorial
          </span>
          <AnimatedText 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-7 flex flex-col group cursor-pointer">
            ...
            <div className="mt-8">
              <span className="text-[10px] font-bold tracking-[0.2em] opacity-40">{articles[0].category} // {articles[0].date}</span>
          ...
          <div className="lg:col-span-5 flex flex-col gap-24 pt-12">
            {articles.slice(1).map((article) => (
              <div key={article.id} className="flex flex-col group cursor-pointer">
                ...
                <div className="mt-6">
                  <span className="text-[10px] font-bold tracking-[0.2em] opacity-40">{article.category} // {article.date}</span>
            ...
            <div className="mt-auto pt-12 border-t border-white/10">
              <a href="#" className="inline-flex items-center gap-4 group">
                 <span className="text-xs font-bold tracking-[0.3em]">View Digital Archive</span>
                 <svg 

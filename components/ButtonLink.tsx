...
export function ButtonLink({
  ...
  return (
    <PrismicNextLink
      className={clsx(
        "button-cutout group mx-4 inline-flex items-center font-bold tracking-wide transition-colors duration-300",
        size === "sm" && "gap-2.5 py-2 text-base",
        size === "md" && "gap-3 px-1 text-lg py-2.5 md:py-3",
        size === "lg" && "text-lg md:text-2xl gap-3 md:gap-4 px-1 md:px-2 py-3 md:py-4",
        color === "orange" &&
        "bg-violet-600 text-white hover:bg-violet-500",
        color === "purple" &&
        "bg-violet-600 text-white hover:bg-violet-500",
        color === "lime" && "bg-violet-600 text-white hover:bg-violet-500",
        className
      )}
      {...props}
    >
